  ...
  public partial class Form1 : Form
  {
    ...
    private void btnUploadFile_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        MessageBox.Show("Upload file completed.", "WebClient - FTP Protocol", MessageBoxButtons.OK, MessageBoxIcon.Information);
      }
      catch (WebException ex)
      {
        Console.WriteLine(ex.StackTrace.ToString());
    ...
    private void btnUploadData_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        MessageBox.Show("Upload data completed.", "WebClient - FTP Protocol", MessageBoxButtons.OK, MessageBoxIcon.Information);
      }
      catch (WebException ex)
      {
        Console.WriteLine(ex.StackTrace.ToString());
